...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('auth')->middleware('guest')->name('auth.')->group(function () {
        ...
        // Commented out routes preserved
        // Route::post('/register', [AuthController::class, 'register'])->name('register');
        Route::post('/forgot-password', [ForgotResetPasswordController::class, 'forgotPassword'])->name('forgot-password');
        Route::post('/reset-password', [ForgotResetPasswordController::class, 'resetPassword'])->name('reset-password');
