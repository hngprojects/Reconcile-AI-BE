...
class AccountChartCategoryController extends Controller
{
    ...
    /**
     * Get all user chart account categories
     *
     * @OA\Get(
     *     path="/api/v1/me/chart-account-categories",
     *     summary="Get all authenticated user chart account categories",
     *     description="Retrieves a list of all chart account categories",
     *     tags={"Chart Account Categories"},
     *     security={{"bearerAuth":{}}},
     *     @OA\Response(
...

    {
        ...
        $categories = $user->accountChartCategories;
        return response()->json([
            'message' => 'Chart account categories retrieved successfully',
            'status' => 'success',
            'status_code' => 200,
    ...
    public function toggle_category(Request $request)
    {
        ...
        $user->accountChartCategories()->toggle($category);
        return response()->json([
            'message' => 'Chart account category updated successfully',
            'status' => 'success',
            'status_code' => 200,
            'data' => $user->accountChartCategories
        ], 200);
    }
}
