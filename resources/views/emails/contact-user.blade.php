    ...
    <div class="container">
        ...
        <div class="content">
            <div class="illustration">
                <img src="{{ url('assets/personal-data.svg') }}" alt="ID Badge">
            </div>
        ...
        <div class="footer">
            <div class="social-icons">
                <a href="https://www.instagram.com/reconxi02/">
                    <img src="{{ url('assets/instagram-icon.png') }}" alt="Instagram">
                </a>
                <a href="https://www.facebook.com/profile.php?id=61573471907361">
                    <img src="{{ url('assets/facebook-icon.png') }}" alt="Facebook">
                </a>
                <a href="https://www.linkedin.com/in/recon-xi-b06835354">
                    <img src="{{ url('assets/linkedin-icon.png') }}" alt="LinkedIn">
                </a>
                <a href="https://x.com/reconxi02">
                    <img src="{{ url('assets/twitter-icon.png') }}" alt="Twitter">
                </a>
            </div>
