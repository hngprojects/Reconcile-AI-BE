...
<body>
    ...
    <div class="social-icons">
            <a href="https://www.instagram.com/reconxi02/?igsh=YTh5aWx6Y2c2dW0w#">
                <img src="{{ url('assets/instagram-icon.svg') }}" alt="Instagram" class="social-icon">
            </a>
            <a href="https://www.facebook.com/profile.php?id=61573471907361&mibextid=rS40aB7S9Ucbxw6v">
                <img src="{{ url('assets/facebook-icon.svg') }}" alt="Facebook" class="social-icon">
            </a>
            <a href="https://www.linkedin.com/in/recon-xi-b06835354">
                <img src="{{ url('assets/linkedin-icon.svg') }}" alt="Linkedin" class="social-icon">
            </a>
            <a href="https://x.com/reconxi02?s=21&t=6GEcIpxFOrczvmtrZsCzSw">
                <img src="{{ url('assets/twitter-icon.svg') }}" alt="Twitter" class="social-icon">
            </a>
        </div>
